import { type CliCommand, type CliCommandDescription, type CliParameter, Console, type ICliPackageCommand, type Package, type Project } from '@kartoffelgames/environment-core';

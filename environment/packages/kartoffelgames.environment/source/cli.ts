import { Process, ExecutionContext, Package, ProcessParameter } from '@kartoffelgames/environment.core';
...
(() => {
    ...
    const lProcessParameter: ProcessParameter = new ProcessParameter(ExecutionContext.workingDirectory, ['node', lKgCliPath, ...lKgCommandParts]);
